...
public:
    ...
    void setupUi(QWidget *ContactItem)
    {
        ...
        verticalSpacer = new QSpacerItem(108, 5, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
        ...
        verticalSpacer_2 = new QSpacerItem(108, 5, QSizePolicy::Policy::Minimum, QSizePolicy::Policy::Expanding);
